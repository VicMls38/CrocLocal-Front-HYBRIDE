...
export default function LoginScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      Découvre et achète les meilleurs produits locaux ! 🥕🛒🚜
      </Text>
      ...
      <TouchableOpacity style={styles.button} onPress={() => router.push("/accueilConsommateur")}>
      ...
      <TouchableOpacity onPress={() => router.push("/inscriptionConsommateur")}>
