  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <TextInput style={styles.inputFull} placeholder="Téléphone*" keyboardType="phone-pad" />
        ...
        <View style={styles.checkboxContainer}>
          <BouncyCheckbox
            ...
            onPress={(isChecked: boolean) => {}}
          />
          <Text style={styles.checkboxText}>J’accepte de recevoir des newsletters</Text>
        </View>
        ...
        <TouchableOpacity onPress={() => router.push("/connexionConsommateur")}>
