...
const TabTwoScreen = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Commandes et paniers</Text>
        <TouchableOpacity onPress={() => toggleSection('profile')} style={styles.sectionItem}>
          <View style={styles.sectionItemContent}>
            <Icon name="cart" size={24} color="#4CAF50" />
            <Text style={styles.sectionItemText}>Explication paniers</Text>
          </View>
          <Icon
            name={collapsedSections.profile ? 'chevron-forward' : 'chevron-down'}
            size={24}
        ...
        {!collapsedSections.profile && (
          <Text style={styles.sectionDescription}>
            Découvre à quoi correspond la taille de nos paniers
          </Text>
        )}
      </View>
